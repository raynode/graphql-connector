...
export const isIntValueNode = (node: any): node is IntValueNode => node.kind === 'IntValue'
export const isStringValueNode = (node: any): node is StringValueNode => node.kind === 'StringValue'
